...
public:
 ...
 /// Enable dropout.
            ...
            void EnableDropout(const bool enable);
                ...
                /*! \param batchFrom The start index of the mini-batch to perform the operation.
                       *  \param batchTo The end index of the mini-batch to perform the operation.  
                            */                                                                           
	...
	int check_weight_ratio(const std::string &path,int in_M_R,int in_M_F);
