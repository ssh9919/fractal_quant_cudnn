...
/* IBM check start */
/* flag for quantization */
#define QUANT_RELU 0 //Signal quantization flag
#define QUANT_DIRECT 1 //Direct quantization flag
#define QUANT_RETRAIN 1 //Retrain based quantization flag
/* flag for quantization */
/* IBM check start */
