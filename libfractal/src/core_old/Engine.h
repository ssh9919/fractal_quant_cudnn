...
public:
    ...
    /* Y = f(X) */
    void FuncSigmoid(Matrix<FLOAT> &X, Matrix<FLOAT> &Y, PStream &stream,FLOAT delta);
    ...
    void FuncRectLinear(Matrix<FLOAT> &X, Matrix<FLOAT> &Y, PStream &stream, FLOAT delta, int M,int relu_delta_final_decision);
